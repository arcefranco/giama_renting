...
import AlquileresForm_2 from "../AlquileresForm/AlquileresForm_2.jsx";
import {
  postContratoAlquiler_2, getContratosByIdVehiculo,
...
const ContratoAlquiler_2 = () => {
  ...
  const handleFinalSubmit = (formAlquiler) => {
    ...
    dispatch(postContratoAlquiler_2(payload));
  };
...
export default ContratoAlquiler_2;