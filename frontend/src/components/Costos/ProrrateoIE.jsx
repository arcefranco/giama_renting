...
const ProrrateoIE = () => {
  ...
  const handleChangeNumbers = (e) => {
    ...
    if (name === "tasa_IIBB_CABA") {
      ...
      newForm.importe_tasa_IIBB_CABA = parseFloat(((parsedValue / 100) * totalNetoCalc).toFixed(2));
    }

    if (name === "tasa_IIBB") {
      newForm.tasa_IIBB = parsedValue;
      newForm.importe_tasa_IIBB = parseFloat(((parsedValue / 100) * totalNetoCalc).toFixed(2));
    }

    if (name === "tasa_IVA") {
      newForm.tasa_IVA = parsedValue;
      newForm.importe_tasa_IVA = parseFloat(((parsedValue / 100) * totalNetoCalc).toFixed(2));
    }
